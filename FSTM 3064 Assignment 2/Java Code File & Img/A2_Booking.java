...
public class test2 extends JFrame{
	...
	JComboBox<String> toCB =new JComboBox<String>();
    JComboBox<String> fromCB =new JComboBox<String>();
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                switch (s) {//check for a match
                    case "  Kelana Jaya Line":
                    	...
                    	fromCB.setModel(new DefaultComboBoxModel<String>(From1));  
                    	toCB.setModel(new DefaultComboBoxModel<String>(To1));
                    ...
                    case "  Sri Petaling Line":
                    	...
                    	fromCB.setModel(new DefaultComboBoxModel<String>(From2));  
                    	toCB.setModel(new DefaultComboBoxModel<String>(To2));
                    ...
                    case "  Ampang Line":
                    	...
                    	fromCB.setModel(new DefaultComboBoxModel<String>(From3));  
                    	toCB.setModel(new DefaultComboBoxModel<String>(To3));
	...
	public void FareCart() {
        ...
        b2 = fromCB.getItemAt(fromCB.getSelectedIndex()); 
        b3 = toCB.getItemAt(toCB.getSelectedIndex()); 
		...
		JTextField promo = new JTextField();
	...
	public void Payment() {
		...
		JTextField expDate = new JTextField(" MM/YY");
        ...
        AnimateUp animateUp = new AnimateUp(credit, from, to);
...
class test4 extends BasicComboBoxUI {
